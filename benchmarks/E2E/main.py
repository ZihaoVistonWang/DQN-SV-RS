...
from theorem_1 import get_order_label
...
wholesaler = E2E_Replenishment_Agent("wholesaler")
...
for episode in tqdm(
    ...
    for t in range(1, args.T+1):
        ...
        wholesaler_order, _, _ = wholesaler.eval(input_DF_dm, input_VLT_lr, init_inventory, input_Q, input_DF_dr, input_VLT_lw)
        ...
        # train the wholesaler E2E agent
        # get label
        label_DF = demand_retailer
        label_VLT = train_lw_t[episode, t]
        label_order = get_order_label(
            episode,
            t,
            train_d_t,
            train_lw_t,
