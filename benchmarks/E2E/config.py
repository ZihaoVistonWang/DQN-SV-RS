...
class Args:
    def __init__(self):
        self.default_args = {
            ...
            'momentum': {
                ...
                'type': float,
                'default': 0.85,
                'help': 'the momentum of the Adam optimizer'
            },
            'learning_rate_decay': {
                'abbr': 'lr_decay',
                'type': float,
            ...
            'input_DF_size': {
                ...
                'type': int,
                'default': None,
                'help': 'the size of input layer of DF submodule'
            },
            'hidden_DF_size': {
                'abbr': 'hid_df_sz',
                'type': int,
                'default': 64,
                'help': 'the size of hidden layer of DF submodule'
            },
            'out_2_size': {
                'abbr': 'out_2_sz',
                'type': int,
                'default': 1,
                'help': 'the size of output layer of DF submodule'
            },
            'input_VLT_size': {
                'abbr': 'in_vlt_sz',
                'type': int,
                'default': None,
                'help': 'the size of input layer of VLT submodule'
            },
            'hidden_VLT_size': {
                'abbr': 'hid_vlt_sz',
                'type': int,
                'default': 4,
                'help': 'the size of hidden layer of VLT submodule'
            },
            'out_3_size': {
                'abbr': 'out_3_sz',
                'type': int,
                'default': 1,
                'help': 'the size of output layer of VLT submodule'
            },
            'dropout_prob': {
                'abbr': 'drop_prob',
                'type': float,
            ...
            'init_inventory_size': {
                ...
                'type': int,
                'default': None,
                'help': 'the size of initial stock'
            },
            'input_I_size': {
                'abbr': 'in_i_sz',
                'type': int,
                'default': None,
                'help': 'the size of input layer of Integration module'
            },
            'hidden_I_size': {
                'abbr': 'hid_i_sz',
                'type': int,
                'default': 10,
                'help': 'the size of hidden layer of Integration module'
            },
            'out_1_size': {
                'abbr': 'out_1_sz',
                'type': int,
                'default': 1,
                'help': 'the size of output layer of Integration module'
            },
            'lambda_1': {
                'abbr': 'lmd_1',
                'type': float,
                'default': 0.1,
                'help': 'the weight of the first loss function'
                },
            'lambda_2': {
                'abbr': 'lmd_2',
                'type': float,
                'default': 0.1,
                'help': 'the weight of the second loss function'
            },
            'num_quantiles': {
                'abbr': 'num_q',
                'type': int,
                'default': 3,
                'help': 'the number of quantiles of MQRNN'
            },
    ...
    def add_calculated_args(self):
        ...
        self.args.input_DF_size = self.args.tau
        self.args.input_VLT_size = self.args.tau
        self.args.init_inventory_size = self.args.k
        self.args.input_I_size = self.args.out_2_size + self.args.out_3_size
...
class Data_Store:
    ...
    def record(self,
        ...
        def record_agent_data(agent, prefix):
            self.recorders[f'{prefix}_loss'].add_data([test_iteration] + [episode] + list(agent.losses[1:-1]))
            self.writer.add_scalar(f'{prefix}/loss', np.mean(agent.losses[1:-1]), step)
